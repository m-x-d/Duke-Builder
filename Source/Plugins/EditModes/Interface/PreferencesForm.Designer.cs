namespace mxd.DukeBuilder.EditModes
{
	partial class PreferencesForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.splitlinedefsrange = new mxd.DukeBuilder.Controls.ButtonsNumericTextbox();
			this.stitchrange = new mxd.DukeBuilder.Controls.ButtonsNumericTextbox();
			this.highlightthingsrange = new mxd.DukeBuilder.Controls.ButtonsNumericTextbox();
			this.highlightrange = new mxd.DukeBuilder.Controls.ButtonsNumericTextbox();
		...
		private mxd.DukeBuilder.Controls.ButtonsNumericTextbox splitlinedefsrange;
		private mxd.DukeBuilder.Controls.ButtonsNumericTextbox stitchrange;
		private mxd.DukeBuilder.Controls.ButtonsNumericTextbox highlightthingsrange;
		private mxd.DukeBuilder.Controls.ButtonsNumericTextbox highlightrange;
