namespace mxd.DukeBuilder.EditModes
{
	partial class CurveLinedefsForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.vertices = new mxd.DukeBuilder.Controls.NumericTextbox();
			this.distance = new mxd.DukeBuilder.Controls.NumericTextbox();
			this.angle = new mxd.DukeBuilder.Controls.NumericTextbox();
		...
		private mxd.DukeBuilder.Controls.NumericTextbox vertices;
		private mxd.DukeBuilder.Controls.NumericTextbox distance;
		private mxd.DukeBuilder.Controls.NumericTextbox angle;
