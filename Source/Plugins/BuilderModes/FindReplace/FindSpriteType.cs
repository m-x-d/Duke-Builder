...
{
	[FindReplace("Sprite Type", BrowseButton = true)]
	internal class FindSpriteType : FindReplaceType
	{
		#region ================== Constants
		...
		public override string Browse(string initialvalue)
		{
			...
			type = General.Interface.BrowseSpriteType(BuilderPlug.Me.FindReplaceForm, type);
		...
		public override FindReplaceObject[] Find(string value, bool withinselection, string replacewith, bool keepselection)
		{
			...
			if(int.TryParse(value, out findtype))
			{
				...
				{
					// Match?
					if(t.TileIndex == findtype)
					{
						// Replace
						if(replacewith != null)
						{
							t.TileIndex = replacetype;
