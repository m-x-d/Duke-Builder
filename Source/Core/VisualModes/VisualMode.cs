...
namespace mxd.DukeBuilder.VisualModes
{
	/// <summary>
	...
	public abstract class VisualMode : EditMode
	{
		...
		/// </summary>
		public VisualThing GetVisualSprite(Thing t) { return allthings[t]; }
		...
		public override void OnProcess(double deltatime)
		{
			...
			// Move the camera
			double multiplier = (General.Interface.ShiftState ? MOVE_SPEED_MULTIPLIER * 2.0f : MOVE_SPEED_MULTIPLIER);
