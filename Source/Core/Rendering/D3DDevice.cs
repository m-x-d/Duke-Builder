...
namespace mxd.DukeBuilder.Rendering
{
	internal class D3DDevice
	{
		...
		private HashSet<ID3DResource> resources;
		...
		public bool Initialize()
		{
			...
			font = new TextFont();
			fonttexture = new ResourceImage("mxd.DukeBuilder.Resources.Font.png");
		...
		private PresentParameters CreatePresentParameters(int adapter)
		{
			...
			displaypp.AutoDepthStencilFormat = Format.D24X8; //mxd. Was Format.D16;
