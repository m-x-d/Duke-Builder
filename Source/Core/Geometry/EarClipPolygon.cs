...
namespace mxd.DukeBuilder.Geometry
{
	public sealed class EarClipPolygon : LinkedList<EarClipVertex>
	{
		...
		public void Add(IEnumerable<EarClipVertex> p)
		{
			// Initialize
			foreach(EarClipVertex v in p) AddLast(v);
		}
		...
		{
			Vector2D v1 = Last.Value.Position;
			LinkedListNode<EarClipVertex> n = First;
			uint c = 0;
			Vector2D v2;
