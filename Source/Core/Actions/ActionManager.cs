...
namespace mxd.DukeBuilder.Actions
{
	public class ActionManager
	{
		...
		private HashSet<int> pressedkeys;
...
#if DEBUG
			General.ShowErrorMessage("Unable to invoke action \"" + actionname + "\": action does not exist!", MessageBoxButtons.OK);
#endif
		...
		internal bool KeyReleased(int key)
		{
			...
			// Update pressed keys
			pressedkeys.Remove(strippedkey);
