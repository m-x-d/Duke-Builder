namespace mxd.DukeBuilder.Windows
{
	partial class ImageSetForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.matcheslist = new mxd.DukeBuilder.Controls.ImageBrowserControl();
			...
			this.matcheslist.SelectedItemDoubleClicked += new mxd.DukeBuilder.Controls.ImageBrowserControl.SelectedItemDoubleClickDelegate(this.matcheslist_SelectedItemDoubleClicked);
			// 
			// noresultlabel
			// 
			...
			// pictureBox1
			// 
			this.pictureBox1.Image = global::mxd.DukeBuilder.Properties.Resources.KnownTextureSet;
		...
		private mxd.DukeBuilder.Controls.ImageBrowserControl matcheslist;
