...
namespace mxd.DukeBuilder.Windows
{
	public partial class ExceptionDialog : Form
	{
		...
		public ExceptionDialog(UnhandledExceptionEventArgs e) 
		{
			...
			logpath = Path.Combine(General.SettingsPath, @"DukeBuilderCrash.txt");
		...
		public void Setup() 
		{
			string[] titles =
			{
                ...
                "Hmm... convenient",
                "You made another stupid move!", // SW
                "It is natural to crash", 
                "Who put these here!? Ow!", 
                "Just like Hiroshima",
                "Just like Nagasaki",
                "Oh, must be American made",
                "This is not a charade",
                "That's no ordinary bug",     
                "BANZAII!!", 
                "Sorry, you no win this time, try again",            
				"0x000000 at 0xFFFFFF. That's probably bad", // GZDB
				"Here we go again...",
				...
				"This function is only available in the retail version of Duke Builder",
				...
				"WARNING: PROGRAMMING BUG IN DUKE BUILDER!",
				"Something happened",
				"The Device is Error",
			};
		...
		{
			try { System.Diagnostics.Process.Start("https://github.com/m-x-d/Duke-Builder/issues"); } 
