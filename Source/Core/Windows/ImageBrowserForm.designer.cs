namespace mxd.DukeBuilder.Windows
{
	partial class ImageBrowserForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.tvTextureSets = new mxd.DukeBuilder.Controls.MultiSelectTreeview();
			this.browser = new mxd.DukeBuilder.Controls.ImageBrowserControl();
			this.panel = new System.Windows.Forms.Panel();
			this.splitter = new mxd.DukeBuilder.Controls.CollapsibleSplitContainer();
			...
			this.apply.Location = new System.Drawing.Point(682, 369);
			this.apply.Name = "apply";
			this.apply.Size = new System.Drawing.Size(98, 42);
			...
			this.tvTextureSets.SelectionMode = mxd.DukeBuilder.Controls.TreeViewSelectionMode.SingleSelect;
			this.tvTextureSets.Size = new System.Drawing.Size(198, 360);
			...
			this.browser.SelectedItemDoubleClicked += new mxd.DukeBuilder.Controls.ImageBrowserControl.SelectedItemDoubleClickDelegate(this.browser_SelectedItemDoubleClicked);
			this.browser.SelectedItemChanged += new mxd.DukeBuilder.Controls.ImageBrowserControl.SelectedItemChangedDelegate(this.browser_SelectedItemChanged);
			// 
			// panel
			// 
		...
		private mxd.DukeBuilder.Controls.ImageBrowserControl browser;
		private System.Windows.Forms.Button cancel;
		private System.Windows.Forms.Button apply;
		private System.Windows.Forms.ImageList smallimages;
		private mxd.DukeBuilder.Controls.MultiSelectTreeview tvTextureSets;
		private System.Windows.Forms.Panel panel;
		private mxd.DukeBuilder.Controls.CollapsibleSplitContainer splitter;
	}
}