...
{
	partial class SpriteBrowserForm
	{
		/// <summary>
		...
		{
			this.thingslist = new mxd.DukeBuilder.Controls.SpriteBrowserControl();
			...
			this.thingslist.OnTypeDoubleClicked += new mxd.DukeBuilder.Controls.SpriteBrowserControl.TypeDoubleClickDeletegate(this.thingslist_OnTypeDoubleClicked);
			// 
			// cancel
			// 
		...
		private mxd.DukeBuilder.Controls.SpriteBrowserControl thingslist;
