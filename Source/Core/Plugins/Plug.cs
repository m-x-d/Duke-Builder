...
namespace mxd.DukeBuilder.Plugins
{
	/// <summary>
	...
	public class Plug : IDisposable
	{
		...
		/// </summary>
		public virtual void OnActionBegin(mxd.DukeBuilder.Actions.Action action) { }

		/// <summary>
		/// Called when an Action ends.
		/// </summary>
		public virtual void OnActionEnd(mxd.DukeBuilder.Actions.Action action) { }
