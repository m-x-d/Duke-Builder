	...
	public partial class DebugConsole : UserControl
	{
...
#if PROFILE
		private static bool profilerrunning;
#endif
...
#else
			General.ShowErrorMessage(message, MessageBoxButtons.OK);
#endif
		...
		public static void StopProfiler(bool savesnapshot)
		{
			...
			if(PerformanceProfiler.IsActive)
			{
				...
				{
					WriteLine(DebugMessageType.SPECIAL, "Unable to stop the Profiler before starting it!");
				}
			}
			else
			{
