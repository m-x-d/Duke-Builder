...
namespace mxd.DukeBuilder.Controls
{
	...
	/// <summary>
	/// The MultiSelectTreeview control is a regular treeview with multi-selection capability.
	/// </summary>
	[ToolboxItem(true)]
	public class MultiSelectTreeview : TreeView
	{
		...
		{
			if(AfterDeselect != null) AfterDeselect(this, new TreeViewEventArgs(tn));
		}

		protected void OnBeforeDeselect(TreeNode tn)
		{
			if(BeforeDeselect != null) BeforeDeselect(this, new TreeViewEventArgs(tn));
		}

		protected void OnSelectionsChanged()
		{
			if(blnSelectionChanged && SelectionsChanged != null)
		...
		public new TreeNode SelectedNode
		{
			get
			{
				if(!blnInternalCall) throw new NotSupportedException("Use SelectedNodes instead of SelectedNode.");
		...
		/// </summary>
		public TreeViewSelectionMode SelectionMode { get { return selectionMode; } set { selectionMode = value; } }

		/// <summary>
		/// Gets/sets backcolor for selected nodes.
		/// </summary>
		public Color SelectionBackColor { get { return selectionBackColor; } set { selectionBackColor = value; } }
