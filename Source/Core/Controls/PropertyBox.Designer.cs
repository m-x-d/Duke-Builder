namespace mxd.DukeBuilder.Controls
{
	partial class PropertyBox
	{
		...
		private void InitializeComponent()
		{
			...
			this.button.Image = global::mxd.DukeBuilder.Properties.Resources.treeview;
			...
			this.Layout += new System.Windows.Forms.LayoutEventHandler(this.PropertyBox_Layout);
			this.Resize += new System.EventHandler(this.PropertyBox_Resize);
